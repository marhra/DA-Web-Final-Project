<template>
  <b-container fluid>
    ...
    <b-modal :id="infoModal.id" :title="infoModal.title" ok-only @hide="resetInfoModal">
      ...
      <pre>Calories: {{ Math.round(infoModal.calories) }} kcal</pre>
      <pre>Picture: {{ infoModal.image }}</pre>
      <img :src="infoModal.image" alt="Girl in a jacket" />

      <pre>Food allergies: {{ infoModal.cautions }}</pre>
      <pre>Fat: {{ Math.round(this.infoModal.fat) }} g</pre>
      <pre>Protein: {{ Math.round(this.infoModal.protein) }} g</pre>
      <pre>Carbs: {{ Math.round(this.infoModal.carbs) }} g</pre>
      <pre>Ingredients: {{ this.infoModal.ingredientLines }} g</pre>
    </b-modal>
  </b-container>
</template>
